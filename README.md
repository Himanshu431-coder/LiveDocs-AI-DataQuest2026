...
```bash
git clone [https://github.com/YOUR_USERNAME/LiveDocs-AI-DataQuest2026.git](https://github.com/YOUR_USERNAME/LiveDocs-AI-DataQuest2026.git)
...
Open LiveDocs_AI_SourceCode.ipynb in Google Colab.

Upload your API Key when prompted.

Run all cells to launch the Public Gradio Link.
...
<div align="center"> <b>Built with ❤️ for DataQuest 2026</b> </div>
